...
class TestLoginetestedecompras():
  def setup_method(self, method):
    ...
    self.vars = {}
    self.driver.implicitly_wait(20) # comando pra esperar ate 5 segundos pra executar 
  ...
  def test_loginetestedecompras(self):
    ...
    # time.sleep(4) grambiarra pra adicionar tempo entre cliques, nao utilizar pois nao é bem visto, somente provisorio 
